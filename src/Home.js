                            ...
                            <div key={ind} className='flex border rounded-xl bg-white space-x-4 p-4 w-full'>
                                ...
                                <div className='w-full flex flex-col space-y-2 justify-center'>
                                    ...
                                    <div className='flex space-x-3 items-center'>
                                        ...
                                        <p className=''> Riders required : {Math.max(val.riders - count, 0)} ({ (Math.max(val.riders - count, 0) === 0) ? 0 : Math.min(Math.max((val.riders - count) / (data[index].sum - (data[index].restaurants.length * count)) * 100, 0), 100).toFixed(1)} %) </p>
                                    </div>
                                </div>
                            </div>
